    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      ...
      >
        ...
        <input
          ...
          placeholder="nombre@snjsoluciones.com.ar"
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full mt-4 rounded-md bg-white text-black py-2 font-medium hover:bg-white/90 transition disabled:opacity-50"
        >
